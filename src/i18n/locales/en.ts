export default {
  ...
  apps: {
    ...
    notepad: {
      title: 'Notepad',
      untitled: 'Untitled',
      unsavedChanges: 'The text in the {file} file has changed.\n\nDo you want to save the changes?',
      aboutTitle: 'About Notepad',
      aboutText: 'Notepad for Open Web Desktop\nVersion 1.0\n\nCopyright (C) 2026 OWD Project.',
      wordWrap: 'Word Wrap',
      timeDate: 'Time/Date',
      helpTopics: 'Help Topics',
      helpText: 'Notepad is a simple text editor for creating and editing plain text documents.',
      saveToVfs: 'Save to virtual filesystem path:',
      enterFilename: 'Save As (filename):',
    },
    explorer: {
